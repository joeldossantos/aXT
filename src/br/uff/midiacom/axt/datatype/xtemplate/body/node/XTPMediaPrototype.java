...
public class XTPMediaPrototype<T extends XTPMediaPrototype, P extends XTPElement, I extends XMLElementImpl, Ea extends XTPAreaPrototype, Ep extends XTPPropertyPrototype, Ed extends NCLLayoutDescriptor, En extends XTPNode, Ei extends XTPInterface> extends NCLMedia<T, P, I, Ea, Ep, Ed, En, Ei> implements XTPNode<En, P> {
