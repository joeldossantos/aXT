...
public class XTPContextPrototype<T extends XTPContextPrototype, P extends XTPElement, I extends XMLElementImpl, Ept extends XTPPortPrototype, Epp extends XTPPropertyPrototype, En extends XTPNode, Ei extends XTPInterface, El extends XTPLinkPrototype, Em extends NCLMeta, Emt extends NCLMetadata> extends NCLContext<T, P, I, Ept, Epp, En, Ei, El, Em, Emt> implements XTPNode<En, P> {
