...
public class XTPPortType<T extends XTPPortType, P extends XTPElement, I extends XMLElementImpl, En extends NCLNnode, Ei extends NCLInterface> extends NCLPort<T, P, I, En, Ei> implements XTPLabeledElement<T, P> {

    protected StringType xlabel;
    protected StringType select;


    public XTPPortType(String id) throws XMLException {
        super(id);
    }
