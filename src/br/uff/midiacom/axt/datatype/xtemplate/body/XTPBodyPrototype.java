...
public class XTPBodyPrototype<T extends XTPBodyPrototype, P extends XTPElement, I extends XMLElementImpl, Ep extends XTPPortPrototype, En extends XTPNode, El extends XTPLinkPrototype, Ev extends XTPVariablePrototype, Ef extends XTPForEachPrototype> extends XMLElementPrototype<T, P, I> implements XTPElement<T, P> {
