...
public class XTPAreaPrototype<T extends XTPAreaPrototype, P extends XTPElement, I extends XMLElementImpl, Ei extends NCLInterface> extends NCLArea<T, P, I, Ei> implements XTPLabeledElement<T, P> {
